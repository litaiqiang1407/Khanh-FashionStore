    ...
    return (
      <ul className={cx("gender-list")}>
        {genders.map((gender, index) => {
          <li key={index} className={cx("gender-item")}>
            <label className={cx("item-label")}>
              ...
              />
              <span className={cx("item-value")}>{gender}</span>
            </label>
          </li>;
        })}
      </ul>
        ...
        <Row>
          <Col lg={2} className={cx("filter")}>
            ...
            <div className={cx("filter-body")}>
              <div className={cx("filter-gender")}>{renderGenders()}</div>
