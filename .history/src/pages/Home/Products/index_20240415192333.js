...
function Products() {
  ...
  const productsURL = "http://localhost/fashion-store/api/Products.php";
  const categoriesURL = "http://localhost/fashion-store/api/Categories.php";
  ...
  useEffect(() => {
    ...
    const filteredProductsURL = `http://localhost/fashion-store/actions/filterByCategories.php?categories=${selectedCategories.join(
      ","
    )}`;
    interactData(filteredProductsURL, "GET", null, (data) => {
      console.log("Filtered Products:", data); // Add this line for debugging
